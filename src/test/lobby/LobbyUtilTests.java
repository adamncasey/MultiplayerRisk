...
public class LobbyUtilTests {
    ...
    public void playerOrderTests() {
        ...
        NetworkClient client2 = new NetworkClient(router, 1, "name");
        NetworkClient client3 = new NetworkClient(router, 2, "name");
    ...
    public void playerOrderTests4() {
        ...
        NetworkClient client2 = new NetworkClient(router, 0, "name");
        NetworkClient client3 = new NetworkClient(router, 2, "name");
    ...
    public void playerOrderTests7() {
        ...
        NetworkClient client2 = new NetworkClient(router, 0, "name");
        NetworkClient client3 = new NetworkClient(router, 1, "name");
